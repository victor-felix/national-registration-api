...
class CreateNationalRegistrationRequestValidator
extends HapiEntityValidator<CreateNationalRegistrationRequest>
implements RequestValidator<CreateNationalRegistrationRequest> {
  constructor() {
    ...
    const requestSchema = Joi.object<CreateNationalRegistrationRequest>({
  ...
  public validate(request: CreateNationalRegistrationRequest): ResultValidator<CreateNationalRegistrationRequest> {
    return super.validate(request);
  }
}

export default CreateNationalRegistrationRequestValidator
